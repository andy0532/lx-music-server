type WarpSyncHandlerActions<Socket, Actions> = {
  [K in keyof Actions]: (
    ...args: [Socket, ...Parameters<Actions[K]>]
...
declare namespace LX {
  namespace Sync {
    ...
    type ServerSyncHandlerActions<Socket> = WarpSyncHandlerActions<
      Socket,
      ServerSyncActions
    >
    ...
    type ClientSyncHandlerActions<Socket> = WarpSyncHandlerActions<
      Socket,
      ClientSyncActions
    >
